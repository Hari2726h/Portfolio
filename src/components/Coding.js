...
const Coding = () => {
  ...
  return (
    <section className="coding">
      ...
      {/* LeetCode Profile */}
      <p>👨‍💻 LeetCode: 
        <a href="https://leetcode.com/Hari2726H" target="_blank" rel="noreferrer" className="coding-link">
          Hari2726H
        </a>
      </p>
      ...
      <div className="badge-container">
        {/* <a href="https://leetcode.com/Hari2726H" target="_blank" rel="noreferrer">
          <img
